    ...
    <div className="bg-white rounded-3xl relative h-auto flex flex-col p-2">
      ...
      {result && !loading && (
        <div className="flex flex-col p-6 animate-in zoom-in-95 fade-in duration-700">
          ...
          {/* CTA Principal - WhatsApp logo abaixo do card de resumo */}
          <div className="space-y-3 mb-6">
            {/* Urgência */}
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-3 flex items-center space-x-3 animate-in fade-in duration-700">
              <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center shrink-0">
                <Sparkles className="w-5 h-5 text-amber-600" />
              </div>
              <div>
                <p className="text-[10px] font-black text-amber-800 uppercase tracking-wider">Unidades limitadas neste empreendimento</p>
                <p className="text-[9px] text-amber-600 font-medium">Fale agora com um especialista e garanta as melhores condições.</p>
              </div>
            </div>
            ...
            >
              <div className="absolute -inset-1.5 bg-[#25D366] rounded-[20px] blur-md opacity-30 group-hover:opacity-60 transition-all animate-pulse"></div>
              <div className="relative flex items-center justify-between w-full bg-[#25D366] hover:bg-[#20BE5A] text-white py-5 px-5 rounded-2xl shadow-xl shadow-emerald-500/30 transition-all transform hover:-translate-y-1 hover:shadow-2xl">
                 <div className="flex items-center space-x-3">
                   ...
                   <div className="text-left">
                     <p className="text-[11px] font-black uppercase tracking-tight italic leading-tight">Aprovar meu Financiamento Agora</p>
                     <p className="text-[10px] font-bold text-white/80 uppercase mt-1">Falar com Especialista</p>
                   </div>
                 </div>
            ...
            <p className="text-[8px] text-slate-400 font-bold text-center uppercase tracking-widest">Atendimento imediato • Sem compromisso</p>
          </div>
